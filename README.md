...
> 🔗 [link para acessar a API](https://projetointegrador-ce3g.onrender.com/) <br>
> 🔗 Esta API está hospedada e sendo consumida pelo frontend em react - [veja a aplicação funcionando aqui](https://skill-up-do98.onrender.com/). <br>
